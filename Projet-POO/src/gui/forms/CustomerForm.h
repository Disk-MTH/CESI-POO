...
namespace Projet_POO
{
    ...
    private:
        ...
        void initialize()
        {
            ...
            this->dataGridViewAddresses->ColumnHeadersHeightSizeMode =
            ...
            /*-------------------- buttonAdd --------------------*/
            this->buttonAdd->Anchor = AnchorStyles::Top | AnchorStyles::Bottom | AnchorStyles::Left |
                AnchorStyles::Right;
            ...
            /*-------------------- buttonEdit --------------------*/
            this->buttonEdit->Anchor = AnchorStyles::Top | AnchorStyles::Bottom | AnchorStyles::Left |
                AnchorStyles::Right;
            ...
            /*-------------------- buttonDelete --------------------*/
            this->buttonDelete->Anchor = AnchorStyles::Top | AnchorStyles::Bottom | AnchorStyles::Left |
                AnchorStyles::Right;
