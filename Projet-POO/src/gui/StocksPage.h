...
namespace Projet_POO {
	...
	/// <summary>
	/// Description r�sum�e de StocksPage
	/// </summary>
	public ref class StocksPage : public System::Windows::Forms::Form
	{
	public:
		StocksPage(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->labelTitle->Location = System::Drawing::Point(203, 6);
			this->labelTitle->Name = L"labelTitle";
			this->labelTitle->Size = System::Drawing::Size(245, 31);
			this->labelTitle->TabIndex = 9;
			this->labelTitle->Text = L"Gestion des stocks";
			// 
			// StocksPage
			// 
			...
			this->Name = L"StocksPage";
			this->Text = L"StocksPage";
