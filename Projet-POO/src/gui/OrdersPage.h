...
namespace Projet_POO {
	...
	/// <summary>
	/// Description r�sum�e de OrdersPage
	/// </summary>
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->labelTitle->Location = System::Drawing::Point(169, 6);
			this->labelTitle->Name = L"labelTitle";
			this->labelTitle->Size = System::Drawing::Size(313, 31);
			this->labelTitle->TabIndex = 9;
			this->labelTitle->Text = L"Gestion des commandes";
			// 
			// OrdersPage
			// 
